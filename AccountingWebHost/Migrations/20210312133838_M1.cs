        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TotalConvertedInvoice = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Memo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConvertedFromQuoteId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ConvertedFromQuoteId,
            ...
            migrationBuilder.InsertData(
                table: "Organization",
                columns: new[] { "Id", "AddressId", "CountryId", "CreatedAt", "CreatedBy", "CurrencyId", "IsDeleted", "Name", "TypeId", "UpdatedAt", "UpdatedBy" },
                values: new object[] { new Guid("23ad3a5c-3a9e-4837-8501-908dd9017b73"), null, null, null, new Guid("00000000-0000-0000-0000-000000000000"), null, false, "Default", null, null, new Guid("00000000-0000-0000-0000-000000000000") });
