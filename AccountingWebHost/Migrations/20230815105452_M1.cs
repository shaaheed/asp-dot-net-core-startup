    ...
    public partial class M1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSaleDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemSaleDetails_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemSaleDetails_Currency_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currency",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemSaleDetails_TaxCode_TaxId",
                        column: x => x.TaxId,
                        principalTable: "TaxCode",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemSaleDetails_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "ItemSaleDetailsCurrency",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemSaleDetailsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurrencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSaleDetailsCurrency", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemSaleDetailsCurrency_Currency_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currency",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemSaleDetailsCurrency_ItemSaleDetails_ItemSaleDetailsId",
                        column: x => x.ItemSaleDetailsId,
                        principalTable: "ItemSaleDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetails_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetails_Contact_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Contact",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetails_Currency_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currency",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetails_Location_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Location",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetails_TaxCode_TaxId",
                        column: x => x.TaxId,
                        principalTable: "TaxCode",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetails_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Item_ItemPurchaseDetails_PurchaseDetailsId",
                        column: x => x.PurchaseDetailsId,
                        principalTable: "ItemPurchaseDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Item_ItemSaleDetails_SaleDetailsId",
            ...
            migrationBuilder.CreateTable(
                name: "ItemPurchaseDetailsCurrency",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemPurchaseDetailsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurrencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemPurchaseDetailsCurrency", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetailsCurrency_Currency_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currency",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemPurchaseDetailsCurrency_ItemPurchaseDetails_ItemPurchaseDetailsId",
                        column: x => x.ItemPurchaseDetailsId,
                        principalTable: "ItemPurchaseDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemGroup_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemVariantOption_ItemPurchaseDetails_PurchaseDetailsId",
                        column: x => x.PurchaseDetailsId,
                        principalTable: "ItemPurchaseDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemVariantOption_ItemSaleDetails_SaleDetailsId",
                        column: x => x.SaleDetailsId,
                        principalTable: "ItemSaleDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetails_AccountId",
                table: "ItemPurchaseDetails",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetails_CurrencyId",
                table: "ItemPurchaseDetails",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetails_LocationId",
                table: "ItemPurchaseDetails",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetails_SupplierId",
                table: "ItemPurchaseDetails",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetails_TaxId",
                table: "ItemPurchaseDetails",
                column: "TaxId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetails_UnitId",
                table: "ItemPurchaseDetails",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetailsCurrency_CurrencyId",
                table: "ItemPurchaseDetailsCurrency",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPurchaseDetailsCurrency_ItemPurchaseDetailsId",
                table: "ItemPurchaseDetailsCurrency",
                column: "ItemPurchaseDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSaleDetails_AccountId",
                table: "ItemSaleDetails",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSaleDetails_CurrencyId",
                table: "ItemSaleDetails",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSaleDetails_TaxId",
                table: "ItemSaleDetails",
                column: "TaxId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSaleDetails_UnitId",
                table: "ItemSaleDetails",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSaleDetailsCurrency_CurrencyId",
                table: "ItemSaleDetailsCurrency",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSaleDetailsCurrency_ItemSaleDetailsId",
                table: "ItemSaleDetailsCurrency",
                column: "ItemSaleDetailsId");
