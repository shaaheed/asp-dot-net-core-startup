...
namespace Module.Tokens.Domain
{
    public class RefreshTokenCommandHandler : ICommandHandler<RefreshTokenCommand, TokenViewModel>
    {
        ...
        private readonly IRepository<Token> _userTokenRepository;
            ...
            IOptions<JwtTokenOptions> jwtTokenOptions)
        {
            ...
            _userTokenRepository = _unitOfWork.GetRepository<Token>();
        ...
        public async Task<TokenViewModel> Handle(RefreshTokenCommand request, CancellationToken cancellationToken)
        {
            ...
            var tokenModel = await _tokenService.CreateTokenViewModelAsync(userToken.UserId, newJwtToken, newRefreshToken.Token);
