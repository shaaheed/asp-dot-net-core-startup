...
{
    public class ItemPurchaseDetailsDto : ItemDetailsDto
    {
        ...
        public static Expression<Func<ItemPurchaseDetails, ItemPurchaseDetailsDto>> Selector()
        {
            return x => new ItemPurchaseDetailsDto
            {
                Id = x.Id,
