...
{
    public class ProductTransactionListItemDto
    {
        ...
        public static Expression<Func<LineItem, ProductTransactionListItemDto>> Selector()
        {
            return x => new ProductTransactionListItemDto
            {
                Id = x.Id,
