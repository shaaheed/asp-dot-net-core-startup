...
import { InventoryAdjustmentAddRoutingModule } from './adjustments-add-routing.module';
...
@NgModule({
  declarations: [
    InventoryAdjustmentAddComponent
  ],
  imports: [
    InventoryAdjustmentAddRoutingModule,
    CommonModule,
    FormsModule,
    NzFormModule,
    SharedModule,
  ...
  exports: [InventoryAdjustmentAddComponent],
  providers: [ProductsHttpService]
})
export class InventoryAdjustmentAddModule {
