...
import { ProductSalesInfoAddComponent } from './sales-info.component';
...
@NgModule({
  ...
  exports: [ProductSalesInfoAddComponent]
})
export class ProductsSalesInfoModule {
