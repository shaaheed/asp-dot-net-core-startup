...
export class InvoicesViewComponent extends BaseComponent {
  ...
  showCustomerDrawer(customer: any) {
    const module = import('src/app/modules/contacts/drawer/contact-drawer.module');
    const component = import('src/app/modules/contacts/drawer/contact-drawer.component');
