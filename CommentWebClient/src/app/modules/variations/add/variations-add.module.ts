...
import { VariationsAddRoutingModule } from './variations-add-routing.module';
...
@NgModule({
  declarations: [
    VariationsAddComponent
  ],
  imports: [
    VariationsAddRoutingModule,
    CommonModule,
    NzTableModule,
    FormsModule,
    NzFormModule,
  ...
  exports: [VariationsAddComponent]
})
export class VariationsAddModule {
